...
const (
	...
	ProductServiceName = "metrognome.v1.ProductService"
)
...
const (
	...
	// CreateProduct RPC.
	ProductServiceCreateProductProcedure = "/metrognome.v1.ProductService/CreateProduct"
	// ProductServiceListProductsProcedure is the fully-qualified name of the ProductService's
	// ListProducts RPC.
	ProductServiceListProductsProcedure = "/metrognome.v1.ProductService/ListProducts"
	// ProductServiceGetProductProcedure is the fully-qualified name of the ProductService's GetProduct
	// RPC.
	ProductServiceGetProductProcedure = "/metrognome.v1.ProductService/GetProduct"
)

// ProductServiceClient is a client for the metrognome.v1.ProductService service.
...
// NewProductServiceClient constructs a client for the metrognome.v1.ProductService service. By
...
func NewProductServiceClient(httpClient connect.HTTPClient, baseURL string, opts ...connect.ClientOption) ProductServiceClient {
	...
	productServiceMethods := v1.File_metrognome_v1_product_proto.Services().ByName("ProductService").Methods()
...
// CreateProduct calls metrognome.v1.ProductService.CreateProduct.
...
// ListProducts calls metrognome.v1.ProductService.ListProducts.
...
// GetProduct calls metrognome.v1.ProductService.GetProduct.
...
// ProductServiceHandler is an implementation of the metrognome.v1.ProductService service.
...
func NewProductServiceHandler(svc ProductServiceHandler, opts ...connect.HandlerOption) (string, http.Handler) {
	...
	return "/metrognome.v1.ProductService/", http.HandlerFunc(func(w http.ResponseWriter, r *http.Request) {
		switch r.URL.Path {
...
func (UnimplementedProductServiceHandler) CreateProduct(context.Context, *connect.Request[v1.CreateProductRequest]) (*connect.Response[v1.CreateProductResponse], error) {
	return nil, connect.NewError(connect.CodeUnimplemented, errors.New("metrognome.v1.ProductService.CreateProduct is not implemented"))
}
...
func (UnimplementedProductServiceHandler) ListProducts(context.Context, *connect.Request[v1.ListProductsRequest]) (*connect.Response[v1.ListProductsResponse], error) {
	return nil, connect.NewError(connect.CodeUnimplemented, errors.New("metrognome.v1.ProductService.ListProducts is not implemented"))
}
...
func (UnimplementedProductServiceHandler) GetProduct(context.Context, *connect.Request[v1.GetProductRequest]) (*connect.Response[v1.GetProductResponse], error) {
	return nil, connect.NewError(connect.CodeUnimplemented, errors.New("metrognome.v1.ProductService.GetProduct is not implemented"))
}
