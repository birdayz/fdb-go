...
const (
	...
	ApiKeyServiceName = "metrognome.v1.ApiKeyService"
)
...
const (
	...
	// CreateApiKey RPC.
	ApiKeyServiceCreateApiKeyProcedure = "/metrognome.v1.ApiKeyService/CreateApiKey"
	// ApiKeyServiceListApiKeysProcedure is the fully-qualified name of the ApiKeyService's ListApiKeys
	// RPC.
	ApiKeyServiceListApiKeysProcedure = "/metrognome.v1.ApiKeyService/ListApiKeys"
	// ApiKeyServiceRevokeApiKeyProcedure is the fully-qualified name of the ApiKeyService's
	// RevokeApiKey RPC.
	ApiKeyServiceRevokeApiKeyProcedure = "/metrognome.v1.ApiKeyService/RevokeApiKey"
)

// ApiKeyServiceClient is a client for the metrognome.v1.ApiKeyService service.
...
// NewApiKeyServiceClient constructs a client for the metrognome.v1.ApiKeyService service. By
...
func NewApiKeyServiceClient(httpClient connect.HTTPClient, baseURL string, opts ...connect.ClientOption) ApiKeyServiceClient {
	...
	apiKeyServiceMethods := v1.File_metrognome_v1_api_key_proto.Services().ByName("ApiKeyService").Methods()
...
// CreateApiKey calls metrognome.v1.ApiKeyService.CreateApiKey.
...
// ListApiKeys calls metrognome.v1.ApiKeyService.ListApiKeys.
...
// RevokeApiKey calls metrognome.v1.ApiKeyService.RevokeApiKey.
...
// ApiKeyServiceHandler is an implementation of the metrognome.v1.ApiKeyService service.
...
func NewApiKeyServiceHandler(svc ApiKeyServiceHandler, opts ...connect.HandlerOption) (string, http.Handler) {
	...
	return "/metrognome.v1.ApiKeyService/", http.HandlerFunc(func(w http.ResponseWriter, r *http.Request) {
		switch r.URL.Path {
...
func (UnimplementedApiKeyServiceHandler) CreateApiKey(context.Context, *connect.Request[v1.CreateApiKeyRequest]) (*connect.Response[v1.CreateApiKeyResponse], error) {
	return nil, connect.NewError(connect.CodeUnimplemented, errors.New("metrognome.v1.ApiKeyService.CreateApiKey is not implemented"))
}
...
func (UnimplementedApiKeyServiceHandler) ListApiKeys(context.Context, *connect.Request[v1.ListApiKeysRequest]) (*connect.Response[v1.ListApiKeysResponse], error) {
	return nil, connect.NewError(connect.CodeUnimplemented, errors.New("metrognome.v1.ApiKeyService.ListApiKeys is not implemented"))
}
...
func (UnimplementedApiKeyServiceHandler) RevokeApiKey(context.Context, *connect.Request[v1.RevokeApiKeyRequest]) (*connect.Response[v1.RevokeApiKeyResponse], error) {
	return nil, connect.NewError(connect.CodeUnimplemented, errors.New("metrognome.v1.ApiKeyService.RevokeApiKey is not implemented"))
}
