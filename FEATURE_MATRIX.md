...
**371 scenarios · 3030 query/assertion cases** across 18 feature areas — 2650 supported, 115 unsupported-feature pins, 265 error-path pins.
...
| Other | 38 | 326 | 287 | 12 | 27 |
| **Total** | **371** | **3030** | **2650** | **115** | **265** |
...
| `join_using_shapes` | 14 | 9 | 0 | 5 | `JOIN … USING (cols)` has no ON expression of its own — one is |
...
| `cte_published_row_names` | 48 | 37 | 0 | 11 | The row a CTE body publishes to its enclosing query is the row the body |
...
| `ordering_through_a_projection` | 8 | 8 | 0 | 0 | A requested ordering crosses a projection by the projection's result value, |
...
| `derived_star_row_versions` | 5 | 3 | 1 | 1 | A projection-less star over row-versioned tables hides both legs' |
| `derived_star_visibility` | 9 | 9 | 0 | 0 | A derived table or CTE whose body is a projection-less star over a join |
