...
**362 scenarios · 2904 query/assertion cases** across 18 feature areas — 2554 supported, 111 unsupported-feature pins, 239 error-path pins.
...
| DML (INSERT / UPDATE / DELETE) | 26 | 217 | 196 | 1 | 20 |
...
| `unquoted_dml_against_a_quoted_table` | 7 | 4 | 0 | 3 | AN UNQUOTED DML TARGET MUST NOT REACH A TABLE THAT ONLY QUOTES CAN NAME. |
