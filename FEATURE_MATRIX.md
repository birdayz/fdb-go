...
**359 scenarios · 2882 query/assertion cases** across 18 feature areas — 2537 supported, 111 unsupported-feature pins, 234 error-path pins.
...
| Other | 34 | 285 | 250 | 11 | 24 |
| **Total** | **359** | **2882** | **2537** | **111** | **234** |
...
| `quoted_identifier_labels` | 30 | 29 | 1 | 0 | THE RESULT-SET LABEL IS WHERE THE USER SEES THE NAME, so it is the one |
