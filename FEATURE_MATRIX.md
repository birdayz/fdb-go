...
**362 scenarios · 2908 query/assertion cases** across 18 feature areas — 2554 supported, 111 unsupported-feature pins, 243 error-path pins.
...
| DML (INSERT / UPDATE / DELETE) | 26 | 221 | 196 | 1 | 24 |
...
| `unquoted_dml_against_a_quoted_table` | 11 | 4 | 0 | 7 | AN UNQUOTED DML TARGET MUST NOT REACH A TABLE THAT ONLY QUOTES CAN NAME. |
