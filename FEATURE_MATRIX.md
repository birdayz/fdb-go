...
**359 scenarios · 2889 query/assertion cases** across 18 feature areas — 2543 supported, 111 unsupported-feature pins, 235 error-path pins.
...
| Other | 34 | 292 | 256 | 11 | 25 |
| **Total** | **359** | **2889** | **2543** | **111** | **235** |
...
| `quoted_identifier_labels` | 37 | 35 | 1 | 1 | THE RESULT-SET LABEL IS WHERE THE USER SEES THE NAME, so it is the one |
