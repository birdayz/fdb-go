...
**359 scenarios · 2888 query/assertion cases** across 18 feature areas — 2542 supported, 111 unsupported-feature pins, 235 error-path pins.
...
| Other | 34 | 291 | 255 | 11 | 25 |
| **Total** | **359** | **2888** | **2542** | **111** | **235** |
...
| `quoted_identifier_labels` | 36 | 34 | 1 | 1 | THE RESULT-SET LABEL IS WHERE THE USER SEES THE NAME, so it is the one |
