...
**371 scenarios · 3046 query/assertion cases** across 18 feature areas — 2667 supported, 115 unsupported-feature pins, 264 error-path pins.
...
| `cte_published_row_names` | 58 | 47 | 0 | 11 | The row a CTE body publishes to its enclosing query is the row the body |
