...
**357 scenarios · 2841 query/assertion cases** across 18 feature areas — 2497 supported, 110 unsupported-feature pins, 234 error-path pins.
...
| Index usage | 12 | 179 | 176 | 0 | 3 |
| Types | 13 | 148 | 127 | 4 | 17 |
| Keys & primary keys | 5 | 133 | 128 | 0 | 5 |
| Error codes & validation | 4 | 39 | 10 | 3 | 26 |
| End-to-end scenarios | 3 | 20 | 20 | 0 | 0 |
| Other | 34 | 260 | 226 | 10 | 24 |
| **Total** | **357** | **2841** | **2497** | **110** | **234** |
...
| `quoted_identifier_labels` | 5 | 5 | 0 | 0 | THE RESULT-SET LABEL IS WHERE THE USER SEES THE NAME, so it is the one |
