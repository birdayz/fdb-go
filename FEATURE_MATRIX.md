...
**359 scenarios · 2887 query/assertion cases** across 18 feature areas — 2540 supported, 113 unsupported-feature pins, 234 error-path pins.
...
| Other | 34 | 290 | 253 | 13 | 24 |
| **Total** | **359** | **2887** | **2540** | **113** | **234** |
...
| `quoted_identifier_labels` | 35 | 32 | 3 | 0 | THE RESULT-SET LABEL IS WHERE THE USER SEES THE NAME, so it is the one |
