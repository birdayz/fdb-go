...
**371 scenarios · 3031 query/assertion cases** across 18 feature areas — 2650 supported, 116 unsupported-feature pins, 265 error-path pins.
...
| Other | 38 | 327 | 287 | 13 | 27 |
| **Total** | **371** | **3031** | **2650** | **116** | **265** |
...
| `derived_star_row_versions` | 6 | 3 | 2 | 1 | A projection-less star over row-versioned tables hides both legs' |
