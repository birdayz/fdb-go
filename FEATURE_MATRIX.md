...
**362 scenarios · 2919 query/assertion cases** across 18 feature areas — 2557 supported, 114 unsupported-feature pins, 248 error-path pins.
...
| DML (INSERT / UPDATE / DELETE) | 26 | 232 | 199 | 4 | 29 |
...
| `unquoted_dml_against_a_quoted_table` | 22 | 7 | 3 | 12 | AN UNQUOTED DML TARGET MUST NOT REACH A TABLE THAT ONLY QUOTES CAN NAME. |
