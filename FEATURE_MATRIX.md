...
**359 scenarios · 2884 query/assertion cases** across 18 feature areas — 2539 supported, 111 unsupported-feature pins, 234 error-path pins.
...
| Other | 34 | 287 | 252 | 11 | 24 |
| **Total** | **359** | **2884** | **2539** | **111** | **234** |
...
| `quoted_identifier_labels` | 32 | 31 | 1 | 0 | THE RESULT-SET LABEL IS WHERE THE USER SEES THE NAME, so it is the one |
