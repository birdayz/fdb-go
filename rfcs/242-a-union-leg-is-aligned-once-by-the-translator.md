...
Two things not from codex, both from driving the above:
...
- **The watcher's tag guard was uncovered while the forensics one was pinned.** Deleting the
  ...
  tag guard is covered" was true of one of the two copies. At 24 arms each deletion reddens its
  own step's arm and no other.
