...
- **And an enumeration had outgrown itself.** The comment above the pinned labels said "Three states, three messages" and listed NONE, MISSING and UNEXPECTED — for the whole round after DUPLICATED was added as the fourth. It names four now, and says which one a count cannot see.
