...
- **A superseded sentence survived in the homes the r28 delta did not edit** (Torvalds required
  ...
  by the rename rather than chosen, and that the third read is what shows it inert — so it is the
  SET of three that varies one thing, not any pair in it. The correction was closed the way the
