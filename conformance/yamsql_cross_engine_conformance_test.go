...
func castScenario() *yamsql.Scenario {
	return &yamsql.Scenario{
		...
		Tests: []yamsql.Test{
			...
			{Query: "SELECT CAST(CAST(1.0E20 AS BIGINT) AS STRING) FROM t", Rows: [][]any{{"9223372036854775807"}}},
			{Query: "SELECT CAST(CAST(-1.0E20 AS BIGINT) AS STRING) FROM t", Rows: [][]any{{"-9223372036854775808"}}},
