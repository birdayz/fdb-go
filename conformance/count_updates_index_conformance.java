...
class CountUpdatesIndexSteps extends ConformanceBase {
    ...
    public List<Map<String, Object>> scanCountUpdatesIndex(String clusterFile, byte[] subspace, String tenantName) {
        return runInContext(clusterFile, tenantName, context -> {
