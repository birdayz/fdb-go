...
- **Test counts**: 2460 Ginkgo specs + 430 conformance specs + 50 chaos tests + 78 C binding port tests + 30 correctness tests + 15 Go↔CGo interop tests + 200+ binding tester seeds (0 failures, API + directory)
