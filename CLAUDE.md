...
| `FuzzCompareValues` | core SQL three-valued compare — antisymmetry / reflexivity / no-panic across the type-pair × value-magnitude matrix | Clean (93M execs/60s, nightshift-57) |
