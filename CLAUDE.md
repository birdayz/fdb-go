...
- **Test counts**: 2696 Ginkgo specs + 433 conformance specs + 53 chaos tests + 78 C binding port tests + 45 correctness tests + 15 Go↔CGo interop tests + 200+ binding tester seeds (0 failures, API + directory)
