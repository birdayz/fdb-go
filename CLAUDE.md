...
- **Test counts**: 2307 Ginkgo specs + 429 conformance specs + 50 chaos tests + 78 C binding port tests + 30 correctness tests + 15 Go↔CGo interop tests + 200+ binding tester seeds (0 failures, API + directory)
- **Line coverage**: 72.4% (client), 78.8% (record layer). `just coverage` generates HTML report.
