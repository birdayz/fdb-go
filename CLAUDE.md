...
| `FuzzConvertAndOptimise` | C1 → B5 pipeline — Convert + FixpointApply termination + initial-member preservation across random LogicalOperator trees | Clean (146M execs/120s, dayshift-58) |
