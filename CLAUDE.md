...
## Conformance status (updated 2026-04-11)
...
- **Test counts**: 2307 Ginkgo specs + 429 conformance specs + 50 chaos tests + 92 C binding port tests + 15 Go↔CGo interop tests + 380+ binding tester seeds (0 failures, API + directory)
