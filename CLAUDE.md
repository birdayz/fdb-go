...
| `FuzzFixpointApply` | Cascades B6 rule-engine driver — termination, idempotence-at-convergence, initial-member preservation across random expression trees + random rule subsets | Clean (17.9M execs/15s, dayshift-58) |
