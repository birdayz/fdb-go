...
pkg/recordlayer/                    # Main Record Layer implementation
  ...
  query/plan/cascades/              # Cascades planner port (RFC-022 Phase 4.x)
    ...
    rule_*.go                       # 25 logical-rewrite rules (FilterMerge,
...
| `FuzzConvertAndOptimise` | C1 → B5 pipeline — Convert + FixpointApply termination + initial-member preservation across random LogicalOperator trees | Clean (50M execs/60s with 22-rule default set + sub-Reference descent, dayshift-58) |
