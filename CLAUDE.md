...
| `FuzzFixpointApply` | Cascades B6 rule-engine driver — termination, idempotence-at-convergence, initial-member preservation across random expression trees + random rule subsets | Clean (114M execs/120s with 15-rule default set incl. SortMerge, ProjectionMerge, TypeFilterRedundant, DistinctOverSortElim; Union shapes added to seed corpus, dayshift-58) |
