...
| `FuzzConvertAndOptimise` | C1 → B5 pipeline — Convert + FixpointApply termination + initial-member preservation across random LogicalOperator trees | Clean (24.7M execs/20s, dayshift-58) |
