...
| `FuzzCastValue` | SQL CAST(v AS T) across 14 target types × 4 source types — no-panic + NULL pass-through + value-OR-error invariants | Clean (60M execs/60s, nightshift-57) |
