...
- **Test counts**: 2514 Ginkgo specs + 430 conformance specs + 50 chaos tests + 78 C binding port tests + 30 correctness tests + 15 Go↔CGo interop tests + 200+ binding tester seeds (0 failures, API + directory)
- **Line coverage**: 78.8% overall, 82.8% (client), 81.0% (record layer). `just coverage` generates HTML report.
