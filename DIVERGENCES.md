...
| 15c. Scalar cost | Java CostModel compares plan costs | `EstimateCostWith` comparison | **Aligned in role** — the statistics rung, NOT a workaround (retiring it regressed genuine selectivity decisions) |
