...
**336 scenarios · 2674 test cases** — 2332 supported (87.2%), 112 unsupported-feature pins, 230 error-path pins.

| Feature area | Cases | Supported | Unsupported | Error-path | Supported % |
|---|--:|--:|--:|--:|--:|
| Aggregates & GROUP BY | 321 | 288 | 19 | 14 | 89.7% |
