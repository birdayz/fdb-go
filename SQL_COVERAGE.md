...
**319 scenarios · 2545 test cases** — 2232 supported (87.7%), 110 unsupported-feature pins, 203 error-path pins.

| Feature area | Cases | Supported | Unsupported | Error-path | Supported % |
|---|--:|--:|--:|--:|--:|
| Aggregates & GROUP BY | 308 | 278 | 18 | 12 | 90.3% |
