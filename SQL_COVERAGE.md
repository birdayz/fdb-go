...
**319 scenarios · 2514 test cases** — 2218 supported (88.2%), 101 unsupported-feature pins, 195 error-path pins.

| Feature area | Cases | Supported | Unsupported | Error-path | Supported % |
|---|--:|--:|--:|--:|--:|
| Aggregates & GROUP BY | 299 | 272 | 15 | 12 | 91.0% |
