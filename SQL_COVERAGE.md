...
**319 scenarios · 2551 test cases** — 2238 supported (87.7%), 110 unsupported-feature pins, 203 error-path pins.

| Feature area | Cases | Supported | Unsupported | Error-path | Supported % |
|---|--:|--:|--:|--:|--:|
| Aggregates & GROUP BY | 314 | 284 | 18 | 12 | 90.4% |
