...
**319 scenarios · 2544 test cases** — 2231 supported (87.7%), 110 unsupported-feature pins, 203 error-path pins.

| Feature area | Cases | Supported | Unsupported | Error-path | Supported % |
|---|--:|--:|--:|--:|--:|
| Aggregates & GROUP BY | 307 | 277 | 18 | 12 | 90.2% |
