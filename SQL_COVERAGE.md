...
**319 scenarios · 2547 test cases** — 2234 supported (87.7%), 110 unsupported-feature pins, 203 error-path pins.

| Feature area | Cases | Supported | Unsupported | Error-path | Supported % |
|---|--:|--:|--:|--:|--:|
| Aggregates & GROUP BY | 310 | 280 | 18 | 12 | 90.3% |
