...
**319 scenarios · 2516 test cases** — 2220 supported (88.2%), 101 unsupported-feature pins, 195 error-path pins.

| Feature area | Cases | Supported | Unsupported | Error-path | Supported % |
|---|--:|--:|--:|--:|--:|
| Aggregates & GROUP BY | 301 | 274 | 15 | 12 | 91.0% |
