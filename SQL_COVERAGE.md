...
**335 scenarios · 2668 test cases** — 2327 supported (87.2%), 111 unsupported-feature pins, 230 error-path pins.

| Feature area | Cases | Supported | Unsupported | Error-path | Supported % |
|---|--:|--:|--:|--:|--:|
| Aggregates & GROUP BY | 320 | 288 | 18 | 14 | 90.0% |
