...
**359 scenarios · 2865 test cases** — 2521 supported (88.0%), 110 unsupported-feature pins, 234 error-path pins.

| Feature area | Cases | Supported | Unsupported | Error-path | Supported % |
|---|--:|--:|--:|--:|--:|
| Aggregates & GROUP BY | 331 | 298 | 19 | 14 | 90.0% |
