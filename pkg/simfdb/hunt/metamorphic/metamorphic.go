// Package metamorphic is the WRONG-catching SQL oracle for the DST harness (RFC-199 Tier 2). It
...
//
// These Scenarios are the natural target of the LLM-adversarial generator (RFC-199): the LLM's
