...
// fdb.BackendDatabase contract (RFC-179 Tier 1 — "SimFDB"). It is the third backend
...
// This is the RFC-179 "synchronous ready-futures" reuse — the pure-Go client's equivalents
