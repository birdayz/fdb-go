...
// TestRecordLayerOverSimFDB is the RFC-199 keystone payoff: the record layer saves and loads a
...
// TestSimFDBByteReproducibleAcrossRuns proves the RFC-199 payoff: the same seeded workload
