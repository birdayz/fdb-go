...
// getkeyvaluesrequest_pool.go — Pooled MarshalFDB for GetKeyValuesRequest.
//
// MarshalFDB allocates a fresh []byte buffer on every call. On the range-read
// path, this accounts for significant allocations.
