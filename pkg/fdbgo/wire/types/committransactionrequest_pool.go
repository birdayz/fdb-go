...
// committransactionrequest_pool.go — Pooled MarshalFDB for CommitTransactionRequest.
//
// MarshalFDB allocates a fresh []byte buffer on every call. On the commit path
// (the hottest write path), this accounts for ~11% of total allocations.
