...
// the SOLE gate on this decision. It decides whether a LEFT projected-EXISTS
...
// a name-model producer for the outer-join fold).
...
func TestIsScanFamilyLeg(t *testing.T) {
	t.Parallel()
