...
// Regression pin for aggregation whose input is a 2-way join's MERGED
// positional row (STREAMING-AGGREGATE-over-JOIN). The group key / aggregate
...
//
// This test exercises the representative aggregate-over-join shapes and
// asserts they return the correct rows. The schema is unique to this test, so
