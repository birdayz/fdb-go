...
// no Docker. Returns the cluster_file key to use in DSNs. RFC-179: SimFDB validates the
...
// SimFDB is a drop-in backend for the RELATIONAL layer end to end (RFC-179 keystone extended
