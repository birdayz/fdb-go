...
// Projected EXISTS over a BURIED INNER box `(p JOIN q) JOIN r`. The 3-way
...
func TestFDB_BuriedInnerJoinProjectedExists(t *testing.T) {
	...
	if _, err := setup.ExecContext(ctx, "CREATE SCHEMA TEMPLATE s4bibx_tmpl"+
...
// TestFDB_BuriedInnerJoinProjectedExists_Discriminating is the
...
func TestFDB_BuriedInnerJoinProjectedExists_Discriminating(t *testing.T) {
	...
	if _, err := setup.ExecContext(ctx, "CREATE SCHEMA TEMPLATE s4bibxd_tmpl"+
...
func TestFDB_NWayWhereExists(t *testing.T) {
	...
	if _, err := setup.ExecContext(ctx, "CREATE SCHEMA TEMPLATE s4nwe_tmpl"+
		" CREATE TABLE p (id BIGINT, v BIGINT, PRIMARY KEY (id))"+
		" CREATE TABLE q (qid BIGINT, PRIMARY KEY (qid))"+
		" CREATE TABLE r (rid BIGINT, PRIMARY KEY (rid))"+
		" CREATE TABLE e (eid BIGINT, PRIMARY KEY (eid))"); err != nil {
...
// TestFDB_NWayExistsInnerJoin pins the correctness of a projected EXISTS
...
func TestFDB_NWayExistsInnerJoin(t *testing.T) {
	...
	if _, err := setup.ExecContext(ctx, "CREATE SCHEMA TEMPLATE s4nweij_tmpl"+
		" CREATE TABLE p (id BIGINT, v BIGINT, PRIMARY KEY (id))"+
		" CREATE TABLE q (qid BIGINT, PRIMARY KEY (qid))"+
		" CREATE TABLE r (rid BIGINT, PRIMARY KEY (rid))"+
...
func TestFDB_NWayNotExists(t *testing.T) {
	...
	if _, err := setup.ExecContext(ctx, "CREATE SCHEMA TEMPLATE s4nwne_tmpl"+
		" CREATE TABLE p (id BIGINT, v BIGINT, PRIMARY KEY (id))"+
		" CREATE TABLE q (qid BIGINT, PRIMARY KEY (qid))"+
		" CREATE TABLE r (rid BIGINT, PRIMARY KEY (rid))"+
		" CREATE TABLE e (eid BIGINT, PRIMARY KEY (eid))"); err != nil {
...
// TestFDB_FourLegJoinDiscriminating earns the "N-way" name past N=3: a
...
func TestFDB_FourLegJoinDiscriminating(t *testing.T) {
	...
	if _, err := setup.ExecContext(ctx, "CREATE SCHEMA TEMPLATE s4fld_tmpl"+
		" CREATE TABLE p (id BIGINT, v BIGINT, k BIGINT, PRIMARY KEY (id))"+
		" CREATE TABLE q (qid BIGINT, k BIGINT, PRIMARY KEY (qid))"+
		" CREATE TABLE r (rid BIGINT, k BIGINT, PRIMARY KEY (rid))"+
