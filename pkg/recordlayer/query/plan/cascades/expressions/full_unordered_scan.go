...
//
// The QOV flows e.flowedType (RFC-173): Java's scan quantifier
...
//
// Go's UnknownType is the analog of Java's AnyRecord. RFC-173 types the
...
// flowedType as a wildcard (RFC-173), so a typed query scan and an
