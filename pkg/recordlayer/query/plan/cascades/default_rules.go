...
// ImplementTypeFilterRule, ImplementUnionRule). Remaining: covering-
// index + MergeFetchIntoCoveringIndexRule + index-equality / range
// rules — all gated on MatchCandidate / IndexAccessHint
