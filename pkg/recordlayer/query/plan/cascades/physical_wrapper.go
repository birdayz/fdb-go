...
// RelationalExpression interface for the Cascades Memo.
...
func (w *physicalSortWrapper) HintCost(child []properties.Cost) properties.Cost {
	...
	return properties.Cost{
		Cardinality: n * physicalWrapperCostMultiplier,
		CPU:         (child[0].CPU + n*10) * physicalWrapperCostMultiplier,
	}
}
...
var _ physicalPlanExpression = (*physicalSortWrapper)(nil)
