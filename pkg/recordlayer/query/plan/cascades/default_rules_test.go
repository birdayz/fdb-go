...
func TestDefaultRules_EndToEndOptimisation(t *testing.T) {
	...
	innerD := mustConstruct(t, innerDValue, err)
	...
	outerD := mustConstruct(t, outerDValue, err)
	...
	innerF := mustConstruct(t, innerFValue, err)
	...
	outerF := mustConstruct(t, outerFValue, err)
