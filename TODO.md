...
- [ ] **Catalog storage layer (FDB-backed)** — `RecordLayerStoreCatalog` implementation writing to FDB. Mirror Java's SystemTableRegistry subspace layout byte-for-byte. Next-up big piece.
