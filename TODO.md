...
- [~] **4.0 — Foundation types**
  ...
  - [~] `Value` hierarchy — dayshift-46 seeded `Value` interface (with `Evaluate`) + 5 concrete types (Constant, Field, Arithmetic, Boolean, Cast). nightshift-48 + dayshift-49 added Promote, Null, Aggregate, QuantifiedObject, RecordConstructor, ParameterValue, ScalarFunctionValue. swingshift-50 added NotValue (Value-layer boolean negation, Kleene 3VL). Remaining: ~66 of Java's 77 value classes.
