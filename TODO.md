...
- [x] **13 plan-coverage tests** for Distinct/TypeFilter/Union/Intersection/Insert/Delete/Update — closes per-plan-type test gap on the 10-plan RecordQueryPlan hierarchy. Pins GetResultType/GetChildren/GetTargetRecordType/GetComparisonKeyValues/Explain rendering + cross-plan invariants (Union and Intersection hash differently; Insert/Delete/Update hash distinctly; Distinct/Union HashCodeWithoutChildren is consistent across calls).
