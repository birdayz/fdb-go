...
import (
	...
	"fdb.dev/pkg/simfdb/hunt/atomicops"
...
func main() {
	...
	// to fold it into the sweep (RFC-199 Tier 2 — "add a workload, hunt a new surface").
	...
	profiles = append(profiles, atomicops.Profiles()...)
	if *only != "" {
